...
import { vijayavada } from "./data/vijaya"; // Ensure this path is correct
...
const VijayawadaSingle = () => {
  window.scrollTo(0, 0);
  const { id } = useParams();
  const hsp = vijayavada.find((i) => i.id === id);
...
export default VijayawadaSingle;